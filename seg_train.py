if __name__ == '__main__':
    ...
    y_train = load_task3_training_masks(output_size=224)
    x_valid = load_task3_validation_images(output_size=224)
    y_valid = load_task3_validation_masks(output_size=224)

    print(y_train.shape, x_train.shape, y_valid.shape, x_valid.shape)
